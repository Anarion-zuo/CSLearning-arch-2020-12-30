...
**Start by downloading the code for lab 1 from the course GitHub repository by following the instructions [here](https://github.com/MIT-DB-Class/course-info-2018).**
...
6. The last thing that we strongly recommend you do is to go to the
   ...
   `https://github.com/MIT-DB-Class/homework-solns-2018-<athena username>/tree/lab1submit`
